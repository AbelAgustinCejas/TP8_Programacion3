        ...
        <div>
            <table style="width:100%;">
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hlAgregar" runat="server" NavigateUrl="~/AgregarSucursales.aspx">Agregar Sucursales</asp:HyperLink>
                    </td>
                    ...
                    <td style="width:50px;"></td>
                    <td>
                        <asp:HyperLink ID="hlEliminar" runat="server" NavigateUrl="~/EliminarSucursales.aspx">Eliminar Sucursales</asp:HyperLink>
                    </td>
                    <td style="width:200px;"></td>
                </tr>
            </table>
